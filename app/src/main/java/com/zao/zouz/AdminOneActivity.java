 ...
 * @date : 2019/4/27 12:33
 */
public class AdminOneActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    private void initUI() {
        ...
        iv_plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AdminOneActivity.this,ScrollingActivity.class));
            }
        });
    }
